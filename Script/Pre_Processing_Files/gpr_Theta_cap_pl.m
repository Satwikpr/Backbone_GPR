function[pred_gpr,sigma_gpr]=gpr_Theta_cap_pl(new_X)
...
mean_X=[3.88830409356725,-1.08195179370592,59.5871169590644,447.216374269006,0.0275087719298246,17.6242982456140,9.06432748538012,205.944686549707,-1.07191864237505,1.12718073462811,544.828627966881,0.707602339181287,531.861985522883,107516.842105263];
std_X=[1.44164246237966,0.499248337838405,30.0515909896593,54.5025090707945,0.0114451985417223,5.27677381148606,3.88852943446629,149.723329311285,0.528309821941287,0.523103258240328,268.356119637188,0.456199884977320,374.805982044097,72261.6715450446];

%% The most influential predictors on which the GPR model is fitted. 
ind2=[1:7,9,10,11,13,14];
X_pred=new_X(:,ind2);
...
cd .. 
cd Fitted_Models
load('gp_model_Theta_cap_pl.mat')%gp_model_Theta_cap_pl
[pred_gpr,sigma_gpr]=predict(gp_model_Theta_cap_pl,X_new);
